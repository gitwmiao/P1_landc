...
public class FragmentThreeadapter extends BaseAdapter{
    ...
    public FragmentThreeadapter(Context context, ImageLoader imageLoader) {
        this.context = context;
        this.imageLoader = imageLoader;
        this.showArrs = new ArrayList<>();
    }

    public FragmentThreeadapter(Context context, List<GuWenResultBean.ShowArr> showArrs, ImageLoader imageLoader) {
        this.context = context;
        this.imageLoader = imageLoader;
        this.showArrs = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.guwen_it, null);
        ...
        if (showArr != null) {
            ...
            String desc = "60天内带看本房<font color='red'>" + showArr.totalShowing + "</font>次";
