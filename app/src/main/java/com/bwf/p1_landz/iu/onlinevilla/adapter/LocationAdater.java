...
public class LocationAdater extends BaseAdapter{
    private List<ParamListBean> items;
    private Context context;
    private boolean isSecond;//是否是二级列表
    private boolean isMore;

    public LocationAdater(Context context, boolean isSecond) {
        this.context = context;
        this.isSecond = isSecond;
    }
    public LocationAdater(Context context, boolean isSecond,boolean isMore) {
        this.context = context;
        this.isSecond = isSecond;
        this.isMore = isMore;
    }
