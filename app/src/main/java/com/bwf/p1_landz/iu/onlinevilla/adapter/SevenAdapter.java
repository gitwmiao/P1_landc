...
public class SevenAdapter extends BaseAdapter{
    ...
    public SevenAdapter(Context context,ImageLoader imageLoader){
    ...
    public List<ResultOneHouse> getResult() {
        return result;
    }

    public void setResult(List<ResultOneHouse> result) {
        this.result = result;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view!=null){
            ResultOneHouse arrBean =  result.get(i);
