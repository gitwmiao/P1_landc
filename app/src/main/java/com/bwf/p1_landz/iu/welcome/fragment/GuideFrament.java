package com.bwf.p1_landz.iu.welcome.fragment;
...
public class GuideFrament extends BaseFrament{
    ...
    public static GuideFrament newInstance(int positon){
        GuideFrament guideFrament =new GuideFrament();
        guideFrament.positon=positon;
                return guideFrament;
    }
    @Override
